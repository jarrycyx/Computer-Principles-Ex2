...
HD_PWD='/home/cyx/Desktop/EDA2/EDA2_TOP/EDA2_TOP.runs/Digits_dynamic_display_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digits_dynamic_display_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digits_dynamic_display_0.tcl
