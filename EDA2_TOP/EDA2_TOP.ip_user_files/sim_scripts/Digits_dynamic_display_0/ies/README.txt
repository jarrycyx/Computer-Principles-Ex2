...
#
# Generated by export_simulation on Tue Dec 03 22:57:55 CST 2019
#
################################################################################
...
'-reset_run' switch to the './Digits_dynamic_display_0.sh' script.

./Digits_dynamic_display_0.sh -reset_run
...
./Digits_dynamic_display_0.sh -noclean_files

For more information on the script, please type './Digits_dynamic_display_0.sh -help'.
